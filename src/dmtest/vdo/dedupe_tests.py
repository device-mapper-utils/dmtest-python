...
def t_dedupe0(fix: Fixture) -> None:
    with standard_vdo(fix) as vdo:
        verify_dedupe(vdo, 0.0)

def t_dedupe50(fix: Fixture) -> None:
    with standard_vdo(fix) as vdo:
        verify_dedupe(vdo, 0.50)

def t_dedupe75(fix: Fixture) -> None:
    with standard_vdo(fix) as vdo:
        verify_dedupe(vdo, 0.75)

def t_dedupeWithOffsetAndRestart(fix: Fixture) -> None:
    """
...
def t_dedupeWithOverwrite(fix: Fixture) -> None:
    """
